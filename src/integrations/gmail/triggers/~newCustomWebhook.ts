...
import { InputResultMap } from '@useparagon/integrations/gmail';
...
> {
   ...
   */
  readonly id = '89ffe194-8469-4ed9-9b7d-dbcd9662c3c9';
   ...
   */
  description = 'Trigger from any event supported by gmail';
